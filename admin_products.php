...
<section class="add-products">
   ...
   <form action="" method="POST" name="Form" enctype="multipart/form-data" onsubmit="return validateForm()">
      ...
      <input type="submit" value="add product" name="add_product" class="btn btn-primary btn-lg">
   </form>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <div class="price bg-secondary">Rs.<?php echo $fetch_products['price']; ?>/-</div>
         <img class="image" src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="">
         <div class="name"><?php echo $fetch_products['name']; ?></div>
         <div class="details"><?php echo $fetch_products['details']; ?></div>
         <a href="admin_update_product.php?update=<?php echo $fetch_products['id']; ?>" class="btn btn-primary btn-lg">update</a>
         <a href="admin_products.php?delete=<?php echo $fetch_products['id']; ?>" class="btn btn-danger btn-lg" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
