...
<form action="" method="post" enctype="multipart/form-data" name="Form" onsubmit="return validateForm()">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" placeholder="update product name" name="name">
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['price']; ?>" placeholder="update product price" name="price">
   ...
   <input type="submit" value="update product" name="update_product" class="btn btn-primary btn-lg">
   <a href="admin_products.php" class="btn btn-secondary btn-lg">Go back</a>
</form>
...
function validateForm() {
   ...
   var details = document.forms["Form"]["details"].value;
   ...
   if (image == "") {
      alert("Product image must be uploaded");
      return false;
   }
   return true;
}
